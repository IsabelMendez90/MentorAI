...
def obtener_respuesta_chat(messages):
    ...
    headers = {
        ...
        "HTTP-Referer": "https://yourwebsite.com",  # Cambia esto o elimínalo si no lo necesitas
...
if st.session_state.interacciones_chat >= 3:
    st.download_button(label="📄 Descargar Reporte en PDF", data=b"Reporte de Conversación", file_name="Reporte_Challenge_Mentor_AI.pdf", mime="application/pdf")
